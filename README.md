...
### Отображение карты
#### После ввода логиня и пароля и запроса о текущем местоположение, карта отобразится на пользователе, а также покажет места в радиусе 7км. При нажатии на кнопку троеточия откроются кнопки с дополнительными возможностями отображения:
